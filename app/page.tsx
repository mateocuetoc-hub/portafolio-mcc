const projects = [
  {
    n: "01",
    type: "Estructuras de datos en C",
    name: "Proceso Electoral Chileno",
    short: "ELECCIÓN / C",
    copy: "Simulación del proceso electoral presidencial chileno con candidatos, votantes, mesas, Servel, Tricel y distintas estructuras de datos.",
    tags: ["C", "ABB", "Listas enlazadas"],
    url: "https://github.com/mateocuetoc-hub/Codigo-de-Proceso-Electoral-Chileno-Estructura-de-datos-2025",
    art: "election",
  },
  {
    n: "02",
  ...
  },
  {
    ...
    short: "ASISTENCIA",
    copy: "Prototipo académico en Java para representar cursos, estudiantes, sesiones y asistencia escolar.",
    tags: ["Java", "POO", "Maven"],
    url: "https://github.com/mateocuetoc-hub/Gesti-n-de-Asistencia-de-alumnos-de-un-colegio",
    art: "attendance",
  },
  {
    n: "06",
